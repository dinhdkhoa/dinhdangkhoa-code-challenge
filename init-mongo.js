...
db = db.getSiblingDB('challenge-api');

db.createCollection('token');

const getImgURL = (currency) =>
  `https://raw.githubusercontent.com/Switcheo/token-icons/69c13270a5d3c7fd19762a4d83bc4e529605084b/tokens/${currency}.svg`

const mockData = [{"currency":"BLUR","date":"2023-08-29T07:10:40.000Z","price":0.20811525423728813},
    ...
    {"currency":"ZIL","date":"2023-08-29T07:10:50.000Z","price":0.01651813559322034}].map(i => {
        return {...i, image: getImgURL(i.currency) }
    })

db.token.insertMany(mockData);
